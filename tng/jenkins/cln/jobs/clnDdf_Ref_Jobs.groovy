...
multiJob("$basePath/${app.toLowerCase()}-etl-execute") {
    ...
    steps {
        phase('api-caller-seed') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-api-caller')
        }
        phase('data-capture') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-data-capture')
        }
        phase('data-cleaning') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-data-cleaning')
        }
        phase('data-modelling') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-data-modelling')
        }
        phase('delta-engine') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-delta-engine')
        }
        phase('central-data-store') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-central-data-store')
        }
        phase('rules-engine') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-rules-engine')
        }
        phase('central-data-store-cdm') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-central-data-store-cdm')
        }
        phase('data-delivery') {
            phaseJob('cln-ddf-ref/phased/phentaho-etl-data-delivery')
        }
